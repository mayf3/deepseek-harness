...
- **The item shape is deliberately minimal** — `content` plus three-state `status`, with optional `tags`; whole-list replacement needs no stable id, priority, or active-form fields.
